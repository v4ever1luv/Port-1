    ...
    class DrawManager
    {
        ...
        private static void DrawKeys(Vector2 pos)
        {
            switch (GlobalManager.Config.Item("drawoptions").GetValue<StringList>().SelectedIndex)
            {
                case 0:
                  ...
                  //  if (LaneOptions.newPoly != null)
                   // LaneOptions.newPoly.Draw(System.Drawing.Color.Blue);
                    ...
                    //Drawing.DrawText(pos.X, ++col * 25 + pos.Y, System.Drawing.Color.SteelBlue, "Stack Tear Key:{0}", KeyToString(GlobalManager.Config.Item("tearS").GetValue<KeyBind>()));


                    //Drawing.DrawText(pos.X, ++col * 25 + pos.Y, System.Drawing.Color.SteelBlue, "Disable Lane Clear Key:{0}", KeyToString(GlobalManager.Config.Item("disablelane").GetValue<KeyBind>()));
                ...
                case 1:
                    ...
                    //Drawing.DrawText(pos.X, ++col1 * 25 + pos.Y, System.Drawing.Color.LightBlue, "Stack Tear Key:{0}", KeyToString(GlobalManager.Config.Item("tearS").GetValue<KeyBind>()));

                    //Drawing.DrawText(pos.X, ++col1 * 25 + pos.Y, System.Drawing.Color.LightBlue, "Disable Lane Clear Key:{0}", KeyToString(GlobalManager.Config.Item("disablelane").GetValue<KeyBind>()));
        ...
        public static void Drawing_OnDraw(EventArgs args)
        {
           ...
           // if (!GlobalManager.GetHero.Position.IsOnScreen())
            ...
            var textDimension = Drawing.GetTextEntent("Stunnable!", 0);
            ...
            foreach (var unit in HeroManager.Enemies.Where(h => h.IsValid && h.IsHPBarRendered))
            {
                ...
                switch (GlobalManager.Config.Item("drawoptions").GetValue<StringList>().SelectedIndex)
                {
                    case 0:
                        ...
                        {
                            Drawing.DrawLine(pos1 + i - 10, yPos, pos1 + i - 10, yPos + Height, 1, _fillColor);
                        }
                        break;
                    case 1:
                        ...
                        {
                            Drawing.DrawLine(pos11 + i -10, yPos, pos11 + i -10, yPos + Height, 1, _fillColorblind);
                        }
                        break;
                }
            }
