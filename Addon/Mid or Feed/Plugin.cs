...
namespace Mid_or_Feed
{
    ...
    public abstract class Plugin
    {
        ...
        {
            Chat.Print("<font color='#3492EB'>Mid or Feed:</font> <font color='#FFFFFF'>" + msg + "</font>");
        }
        ...
        /// <returns></returns>
        public virtual float GetComboDamage(AIHeroClient target)
        {
            return 0;
        }
        ...
        /// <returns></returns>
        private float DamageToUnit(AIHeroClient hero)
        {
