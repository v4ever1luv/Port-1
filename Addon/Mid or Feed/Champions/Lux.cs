...
namespace Mid_or_Feed.Champions
{
    ...
    internal class Lux : Plugin
    {
        ...
        public Lux()
        {
            ...
            EloBuddy.SDK.Events.Teleport.OnTeleport += this.ObjAiHeroOnOnTeleport;
        ...
        private void ObjAiHeroOnOnTeleport(Obj_AI_Base sender, EloBuddy.SDK.Events.Teleport.TeleportEventArgs args)
        {
            ...
            var hero = ObjectManager.GetUnitByNetworkId<AIHeroClient>((uint)sender.NetworkId);

            if (hero.IsAlly || args.Type != TeleportType.Recall
