    ...
    internal class Yasuo : Plugin
    {
        ...
        private void DoCombo()
        {
            ...
            if (useE && useQ && this.Q.IsReady() && this.E.IsReady() && this.E.IsInRange(target, this.E.Range))
            {
                ...
                LeagueSharp.Common.Utility.DelayAction.Add(castTime, delegate { Q.Cast(target, Packets); });
        ...
        private void DoWaveClear()
        {
            ...
            if (useQ && useE && this.Q.IsReady() && this.E.IsReady())
            {
                ...
                LeagueSharp.Common.Utility.DelayAction.Add(castTimeDelay, () => this.Q.Cast(nearestMinion, this.Packets));
            }
