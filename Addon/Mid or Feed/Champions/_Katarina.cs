namespace Mid_or_Feed.Champions
{
    ...
    internal class _Katarina : Plugin
    {
        ...
        public _Katarina()
        {
            ...
            EloBuddy.Player.OnIssueOrder += this.ObjAiBaseOnOnIssueOrder;
        ...
        private bool IsChannelingR
        {
            get
            {
                return this.Player.HasBuff("katarinarsound");
            }
        }
        ...
        private void DoCombo()
        {
            ...
            if (mode == 0)
            {
                ...
                {
                    EloBuddy.Player.IssueOrder(GameObjectOrder.HoldPosition, ObjectManager.Player);

                    this.Orbwalker.SetMovement(false);
                    this.Orbwalker.SetAttack(false);

                    LeagueSharp.Common.Utility.DelayAction.Add(Game.Ping / 2, () => { this.R.Cast(); });
                }
            }
            // EQW
            else if (mode == 1)
        ...
        private void ObjAiBaseOnOnIssueOrder(Obj_AI_Base sender, PlayerIssueOrderEventArgs args)
        {
        ...
        private void ObjAiBaseOnOnProcessSpellCast(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs args)
        {
            ...
            {
                //LeagueSharp.Common.Utility.DelayAction.Add(0, () => Player.IssueOrder(GameObjectOrder.MoveTo, ObjectManager.Player.Position));
            }
        }
        ...
        private void SpellbookOnOnStopCast(Obj_AI_Base sender, SpellbookStopCastEventArgs args)
        {
            if (!sender.IsMe)
            {
                return;
