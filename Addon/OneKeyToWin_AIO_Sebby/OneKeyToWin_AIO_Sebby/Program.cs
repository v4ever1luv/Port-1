    ...
    class Program
    {
        ...
        private static void OnUpdate(EventArgs args)
        {
            ...
            else
            {
                ...
                Farm = (Orbwalker.ActiveMode == Orbwalking.OrbwalkingMode.LaneClear && Config.Item("harassLaneclear").GetValue<bool>()) || Orbwalker.ActiveMode == Orbwalking.OrbwalkingMode.Mixed || Orbwalker.ActiveMode == Orbwalking.OrbwalkingMode.Freeze;
