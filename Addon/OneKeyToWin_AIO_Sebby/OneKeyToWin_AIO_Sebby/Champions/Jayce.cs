                ...
                if (Config.Item("onlyRdy", true).GetValue<bool>())
                {
                    if (Q.IsReady())
                    {
                        if (Range)
                        {
                            ...
                            LeagueSharp.Common.Utility.DrawCircle(Player.Position, Q1.Range, System.Drawing.Color.Orange, 1, 1);
                    }
                }
                else
                {
                    if (Range)
                    {
                        ...
                        LeagueSharp.Common.Utility.DrawCircle(Player.Position, Q1.Range, System.Drawing.Color.Cyan, 1, 1);
                }
            }
