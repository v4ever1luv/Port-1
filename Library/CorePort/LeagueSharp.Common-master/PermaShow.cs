namespace LeagueSharp.Common
{
    ...
    public static class PermaShow
    {
        ...
        {
            subbed = true;
            Drawing.OnPreReset += new DrawingPreReset(DrawingOnPreReset);
            Drawing.OnPostReset += new DrawingPostReset(DrawingOnOnPostReset);
            Drawing.OnDraw += new DrawingDraw(Drawing_OnEndScene);
            AppDomain.CurrentDomain.DomainUnload += new EventHandler(CurrentDomainOnDomainUnload);
            AppDomain.CurrentDomain.ProcessExit += new EventHandler(CurrentDomainOnDomainUnload);
            Game.OnWndProc += new GameWndProc(OnWndProc);
        }
