namespace LeagueSharp.Common
{
    ...
    public class Notifications
    {
        ...
        static Notifications()
        {
            ...
            Drawing.OnPostReset += new DrawingPostReset(Drawing_OnPostReset);
            Drawing.OnPreReset += new DrawingPreReset(Drawing_OnPreReset);
            AppDomain.CurrentDomain.DomainUnload += new EventHandler(CurrentDomain_DomainUnload);
            Game.OnWndProc += new GameWndProc(Game_OnWndProc);
        }
        ...
        private static void Drawing_OnPostReset(EventArgs args)
        {
            foreach (var notification in NotificationsList)
            {
                notification.Value.OnPostReset(args);
            }
        }
        ...
        private static void Drawing_OnPreReset(EventArgs args)
        {
            foreach (var notification in NotificationsList)
            {
                notification.Value.OnPreReset(args);
            }
        }
