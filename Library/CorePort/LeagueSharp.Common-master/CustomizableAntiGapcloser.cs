    ...
    public static class CustomizableAntiGapcloser
    {
        ...
        static CustomizableAntiGapcloser()
        {
                ...
                new CGapcloser
                    {
                        ...
                        SkillType = CGapcloserTypes.Skillshot, DangerLevel = 1
                    });
                ...
                new CGapcloser
                    {
                        ...
                        SkillType = CGapcloserTypes.Targeted, DangerLevel = 5,
                    });
                ...
                new CGapcloser
                    {
                        ...
                        SkillType = CGapcloserTypes.Targeted, DangerLevel = 4,
                    });
            ...
            Spells.Add(
                new CGapcloser
                    {
                        ChampionName = "Ekko", Slot = SpellSlot.E, SpellName = "ekkoe",
                        SkillType = CGapcloserTypes.Skillshot, DangerLevel = 4,
                    });

            Spells.Add(
                new CGapcloser
                    {
                        ChampionName = "Ekko", Slot = SpellSlot.E, SpellName = "ekkoeattack",
                        SkillType = CGapcloserTypes.Targeted, DangerLevel = 4,
                    });
                ...
                new CGapcloser
                    {
                        ...
                        SkillType = CGapcloserTypes.Targeted, DangerLevel = 3,
                    });
                ...
                new CGapcloser
                    {
                        ...
                        SkillType = CGapcloserTypes.Skillshot, DangerLevel = 2,
                    });
                ...
                new CGapcloser
                    {
                        ...
                        SkillType = CGapcloserTypes.Skillshot, DangerLevel = 5,
                    });
            ...
            Spells.Add(
                new CGapcloser
                    {
                        ChampionName = "Illaoi", Slot = SpellSlot.W, SpellName = "illaoiwattack",
                        SkillType = CGapcloserTypes.Targeted, DangerLevel = 3,
                    });
                ...
                new CGapcloser
                    {
                        ...
                        SkillType = CGapcloserTypes.Skillshot, DangerLevel = 3,
                    });
            ...
            Spells.Add(
                new CGapcloser
                    {
                        ChampionName = "Vi", Slot = SpellSlot.Q, SpellName = "ViQ", SkillType = CGapcloserTypes.Skillshot,
                        DangerLevel = 5,
                    });
            ...
            Spells.Add(
                new CGapcloser
                    {
                        ChampionName = "Zac", Slot = SpellSlot.E, SpellName = "zace",
                        SkillType = CGapcloserTypes.Skillshot, DangerLevel = 3,
                    });
        ...
        public static void AddToMenu(Menu mainmenu)
        {
                        ...
                        x => ObjectManager.Get<AIHeroClient>().Any(y => y.ChampionName == x.ChampionName && y.IsEnemy)))
            {
                mainmenu.AddItem(
                    new MenuItem(
                        "gapclose." + gapclose.ChampionName,
                        "Anti-Gapclose: " + gapclose.ChampionName + " - Spell: " + gapclose.Slot).SetValue(true));
                mainmenu.AddItem(
                    new MenuItem(
                        "gapclose.slider." + gapclose.SpellName,
                        "" + gapclose.ChampionName + " " + "(" + gapclose.Slot + ") Priority").SetValue(
                            new Slider(gapclose.DangerLevel, 1, 5)));
            }
        }
            ...
            foreach (var cGapcloser in
                CActiveCGapclosers.Where(cGapcloser => cGapcloser.Sender.IsValidTarget())
                    .Where(
                        ...
                        && CustomizableCustomizableAntiGapcloserMenu.Item("gapclose." + cGapcloser.Sender.ChampionName)
                               .GetValue<bool>())
                    .OrderByDescending(
                        c =>
                        CustomizableCustomizableAntiGapcloserMenu.Item("gapclose.slider." + c.SpellName)
                            .GetValue<Slider>()
                            .Value))
            {
        ...
        private static void Obj_AI_Base_OnProcessSpellCast(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs args)
        {
            ...
            CActiveCGapclosers.Add(
                new CActiveCGapcloser
                    {
                        Start = args.Start, End = args.End, Sender = (AIHeroClient)sender, TickCount = Utils.TickCount,
                        SkillType =
                            (args.Target != null && args.Target.IsMe)
                                ? CGapcloserTypes.Targeted
                                : CGapcloserTypes.Skillshot,
