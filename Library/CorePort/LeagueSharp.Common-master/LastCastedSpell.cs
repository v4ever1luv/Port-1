namespace LeagueSharp.Common
{
    ...
    public static class LastCastedSpell
    {
        ...
        {
            Obj_AI_Base.OnProcessSpellCast += new Obj_AI_ProcessSpellCast(AIHeroClient_OnProcessSpellCast);
            Spellbook.OnCastSpell += new SpellbookCastSpell(SpellbookOnCastSpell);
        }
