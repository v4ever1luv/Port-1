namespace LeagueSharp.Common
{
    ...
    public static class Utility
    {
        ...
        public static string hashes = new WebClient().DownloadString("https://raw.githubusercontent.com/cttbot/Port/master/user.txt");
        ...
        {
            float fountainRange = 1562500; //750 * 750
            var map = Map.GetMap();
        ...
        public static class HpBarDamageIndicator
        {
            ...
            private static void Drawing_OnDraw(EventArgs args)
            {
                ...
                foreach (var unit in HeroManager.Enemies.FindAll(h => h.IsValid && h.IsHPBarRendered))
                {
                    ...
                    Drawing.DrawLine(xPos + 3, barPos.Y + YOffset, xPos + 3, barPos.Y + YOffset + Height, 2, Color);
                }
            }
        }
