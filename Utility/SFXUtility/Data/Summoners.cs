...
/*
 ...
 Summoners.cs is part of SFXUtility.
...
namespace SFXUtility.Data
{
    ...
    internal static class Summoners
    {
        ...
        public static void Cast(this SummonerSpell spell, AIHeroClient target)
        {
        ...
        public static float CalculateComboDamage(AIHeroClient target, bool ignite, bool smite)
        {
            try
            {
                var damage = 0f;
        ...
        public static void UseComboSummoners(AIHeroClient target, bool ignite, bool smite)
        {
            try
            {
                if (ignite && Ignite.Exists() && Ignite.IsReady() &&
