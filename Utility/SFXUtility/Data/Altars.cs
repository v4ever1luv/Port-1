...
/*
 ...
 Altars.cs is part of SFXUtility.
            ...
            try
            {
                Objects = new List<AltarObject>
                {
                    new AltarObject(
                        ...
                        "TT_LockComplete_Red_L.troy", LeagueSharp.Common.Utility.Map.MapType.TwistedTreeline),
                    new AltarObject(
                        180f, 90f, new Vector3(10069.46f, 6744.67f, -37.30f), "TT_LockComplete_Blue_R.troy",
                        "TT_LockComplete_Red_R.troy", LeagueSharp.Common.Utility.Map.MapType.TwistedTreeline)
                };
            }
            catch (Exception ex)
            {
