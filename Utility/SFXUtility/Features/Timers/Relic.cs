...
namespace SFXUtility.Features.Timers
{
    internal class Relic : Child<Timers>
    {
        ...
        {
            get { return new List<LeagueSharp.Common.Utility.Map.MapType> { LeagueSharp.Common.Utility.Map.MapType.SummonersRift }; }
        }
        ...
        protected override void OnInitialize()
        {
            ...
            {
                _relicObjs.AddRange(
                    Relics.Objects.Where(c => c.MapType == LeagueSharp.Common.Utility.Map.GetMap().Type)
