                ...
                Camps = new List<Camp>
                {
                    ...
                    new Camp(
                        ...
                        new List<Mob>(
                            ...
                            }), true, LeagueSharp.Common.Utility.Map.MapType.SummonersRift,
                    ...
                    new Camp(
                        ...
                        new List<Mob>(
                            ...
                            }), false, LeagueSharp.Common.Utility.Map.MapType.SummonersRift,
                        GameObjectTeam.Order),
                    //Order: Chicken
                    new Camp(
                        ...
                        LeagueSharp.Common.Utility.Map.MapType.SummonersRift, GameObjectTeam.Order),
                    //Order: Red
                    new Camp(
                        ...
                        true, LeagueSharp.Common.Utility.Map.MapType.SummonersRift, GameObjectTeam.Order),
                    //Order: Krug
                    new Camp(
                    ...
                    new Camp(
                        ...
                        LeagueSharp.Common.Utility.Map.MapType.SummonersRift, GameObjectTeam.Chaos),
                    //Chaos: Red
                    new Camp(
                        ...
                        new List<Mob>(
                            ...
                            }), true, LeagueSharp.Common.Utility.Map.MapType.SummonersRift, GameObjectTeam.Chaos),
                    //Chaos: Krug
                    new Camp(
                    ...
                    new Camp(
                        ...
                        LeagueSharp.Common.Utility.Map.MapType.SummonersRift, GameObjectTeam.Neutral),
                    //Neutral: Rift Herald
                    new Camp(
                    ...
                    new Camp(
                        ...
                        new List<Mob>(
                            ...
                            }), false, LeagueSharp.Common.Utility.Map.MapType.TwistedTreeline, GameObjectTeam.Order),
                    //Order: Golems
                    new Camp(
                        95, 75, new Vector3(5106.94f, 7985.90f, -108.38f),
                        new List<Mob>(new[] { new Mob("TT_NGolem2.1.1", true), new Mob("TT_NGolem22.1.2") }), false,
                        LeagueSharp.Common.Utility.Map.MapType.TwistedTreeline, GameObjectTeam.Order),
                    //Order: Wolves
                    new Camp(
                    ...
                    new Camp(
                        ...
                        new List<Mob>(
                            new List<Mob>(
                                ...
                                })), false, LeagueSharp.Common.Utility.Map.MapType.TwistedTreeline,
                        GameObjectTeam.Chaos),
                    //Chaos: Golems
                    new Camp(
                        95, 75, new Vector3(10276.81f, 8037.54f, -108.92f),
                        new List<Mob>(new[] { new Mob("TT_NGolem5.1.1", true), new Mob("TT_NGolem25.1.2") }), false,
                        LeagueSharp.Common.Utility.Map.MapType.TwistedTreeline, GameObjectTeam.Chaos),
                    //Chaos: Wolves
                    new Camp(
                        ...
                        false, LeagueSharp.Common.Utility.Map.MapType.TwistedTreeline, GameObjectTeam.Chaos),
                    //Neutral: Vilemaw
                    new Camp(
