...
namespace SFXWard.Classes
{
    public class GenerateReport
    {
        ...
        private static void GenerateOverview()
        {
            ...
            BuildHeroesString(ObjectManager.Get<AIHeroClient>().ToList());
        ...
        private static void BuildHeroesString(List<AIHeroClient> heroes)
        {
        ...
        private static void GenerateHeroes()
        {
            ...
            Builder.Append("[Ally]    : ");
            BuildHeroesString(ObjectManager.Get<AIHeroClient>().Where(h => h.IsAlly).ToList());
            Builder.Append(Environment.NewLine);
            Builder.Append("[Enemy]   : ");
            BuildHeroesString(ObjectManager.Get<AIHeroClient>().Where(h => h.IsEnemy).ToList());
            Builder.Append(Environment.NewLine);
            Builder.AppendLine();
            Builder.AppendLine();
            Builder.AppendLine();
