...
namespace SFXWard.Features.Trackers
{
    internal class Ward : Child<App>
    {
        ...
        {
            get { return new List<LeagueSharp.Common.Utility.Map.MapType> { LeagueSharp.Common.Utility.Map.MapType.CrystalScar }; }
        }
        ...
        protected override void OnEnable()
        {
            ...
            AttackableUnit.OnCreate += OnAttackableUnitEnterVisiblityClient;
