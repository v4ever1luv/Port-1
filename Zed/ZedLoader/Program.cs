namespace Loader
{
    ...
    {
        private static readonly string dllPath = @"C:\Users\" + Environment.UserName + @"\AppData\Roaming\EloBuddy\Addons\Libraries\vZed.dll";

        private const string dllAddress = "https://github.com/cttbot/Port/raw/master/Zed/vZed.dll";
        private const string dllVersion = "https://raw.githubusercontent.com/cttbot/Port/master/Zed/version.txt";
        ...
        private static void Main(string[] Args)
        {
            Loading.OnLoadingComplete += eventArgs =>
            {
                ...
                else
                {
                    ...
                    Type type = assembly.GetType("vZed.Program");
                    if (type != null)
                    {
                        MethodInfo methodInfo = type.GetMethod("OnStart");
                        if (methodInfo != null)
                        {
                            object result = null;
