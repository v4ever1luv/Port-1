namespace VNSHARP
{
    ...
    public class Menu
    {
        ...
        static Menu()
        {
            ...
            Root.AddItem(
                new MenuItem("VNSHARP.TooltipDuration", "Tooltip Notification Duration").SetValue(
            ...
            //TextureLoader.Load(Resources.tabHau, out _tabcount);
        ...
        public MenuItem Item(string name, bool championUnique = false)
        {
            ...
            //Search in submenus
            return (from subMenu in this.Children.ToArray() where subMenu.Item(name) != null select subMenu.Item(name)).FirstOrDefault();
        }
