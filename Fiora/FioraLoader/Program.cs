namespace Loader
{
    ...
    {
        private static readonly string dllPath = @"C:\Users\" + Environment.UserName + @"\AppData\Roaming\EloBuddy\Addons\Libraries\ProjectFiora.dll";

        private const string dllAddress = "https://github.com/cttbot/Port/raw/master/Fiora/ProjectFiora.dll";
        private const string dllVersion = "https://raw.githubusercontent.com/cttbot/Port/master/Fiora/version.txt";
        ...
        private static void Main(string[] Args)
        {
            Loading.OnLoadingComplete += eventArgs =>
            {
                ...
                else
                {
                    ...
                    Type type = assembly.GetType("FioraProject.Program");
                    if (type != null)
                    {
                        MethodInfo methodInfo = type.GetMethod("Game_OnGameLoad");
                        if (methodInfo != null)
                        {
                            object result = null;
