namespace LeagueSharp.Data.DataTypes
{
    ...
    public class DamageDatabase : IDataType
    {
        ...
        /// <returns></returns>
        public ChampionDamage this[AIHeroClient hero] => DamageCollection[hero.ChampionName];
        ...
        {
            foreach (var champion in ObjectManager.Get<AIHeroClient>().Select(h => h.ChampionName).Distinct())
            {
                JToken value;
