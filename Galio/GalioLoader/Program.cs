namespace Loader
{
    ...
    {
        private static readonly string dllPath = @"C:\Users\" + Environment.UserName + @"\AppData\Roaming\EloBuddy\Addons\Libraries\exploitGalio.dll";

        private const string dllAddress = "https://github.com/cttbot/Port/raw/master/Galio/exploitGalio.dll";
        private const string dllVersion = "https://raw.githubusercontent.com/cttbot/Port/master/Galio/version.txt";
        ...
        private static void Main(string[] Args)
        {
            Loading.OnLoadingComplete += eventArgs =>
            {
                ...
                else
                {
                    ...
                    Type type = assembly.GetType("exploitGalio.Program");
                    if (type != null)
                    {
