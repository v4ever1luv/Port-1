namespace VNSHARP
{
    ...
    public static class Render
    {
        ...
        {
            if (Devicea == null || Devicea.IsDisposed)
            {
                return;
            }
        ...
        private static void Drawing_OnEndScene(EventArgs args)
        {
            ...
            Devicea.SetRenderState(RenderState.AlphaBlendEnable, true);
        ...
        public class Circle : RenderObject
        {
            ...
            public static void CreateVertexes()
            {
                ...
                _vertexDeclaration = new VertexDeclaration(Devicea, _vertexElements);
                ...
                try
                {
                    ...
                    */
                    ...
                    _effect = Effect.FromMemory(Devicea, compiledEffect, ShaderFlags.None);
                }
                catch (Exception e)
                {
                    Console.WriteLine(e);
                ...
                bool zDeep = false)
            {
                try
                {
                    ...
                    var olddec = Devicea.VertexDeclaration;
                    ...
                    Devicea.SetStreamSource(0, _vertices, 0, Utilities.SizeOf<Vector4>() * 2);
                    Devicea.VertexDeclaration = _vertexDeclaration;

                    Devicea.DrawPrimitives(PrimitiveType.TriangleList, 0, 2);

                    _effect.EndPass();
                    _effect.End();

                    Devicea.VertexDeclaration = olddec;
                }
                catch (Exception e)
                {
                    _vertices = null;
        ...
        public class Text : RenderObject
        {
            ...
            public FontDescription TextFontDescription
            {
                ...
                set
                {
                    ...
                    this._textFont = new Font(Devicea, value);
                }
            }
